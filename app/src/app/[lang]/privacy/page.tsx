...
export default async function PrivacyPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  const sections = lang === 'th' ? [
    ...
    { title: 'รายชื่อบริษัทจากแหล่งข้อมูลสาธารณะ', body: 'แพลตฟอร์มอาจแสดงข้อมูลธุรกิจที่เปิดเผยต่อสาธารณะของบริษัทที่ยังไม่ได้ลงทะเบียน เพื่อช่วยให้ผู้ที่กำลังมองหาบริการค้นพบผู้ให้บริการ หากคุณเป็นตัวแทนของบริษัทดังกล่าว คุณสามารถขอรับสิทธิ์ (Claim) เพื่อแก้ไข หรือขอให้ลบรายชื่อออกได้ที่ support@profindle.com' },
