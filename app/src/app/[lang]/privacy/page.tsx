...
export default async function PrivacyPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  const sections = lang === 'th' ? [
    { title: 'บทนำและผู้ควบคุมข้อมูล', body: 'Profind (“เรา”) เป็นผู้ให้บริการแพลตฟอร์มตลาดบริการ B2B ที่ profindle.com นโยบายนี้อธิบายว่าเราเก็บรวบรวม ใช้ เปิดเผย และคุ้มครองข้อมูลส่วนบุคคลของคุณอย่างไร ภายใต้พระราชบัญญัติคุ้มครองข้อมูลส่วนบุคคล พ.ศ. 2562 (PDPA) ของประเทศไทย\n\nผู้ควบคุมข้อมูล: Profind ผู้ดำเนินการเว็บไซต์ profindle.com\nติดต่อเรื่องข้อมูลส่วนบุคคล: support@profindle.com' },
    ...
    { title: 'Introduction & Data Controller', body: 'Profind (“we”, “us”) operates the B2B service marketplace at profindle.com. This policy explains how we collect, use, disclose, and protect your personal data under Thailand’s Personal Data Protection Act B.E. 2562 (PDPA).\n\nData controller: Profind, operator of profindle.com\nData protection contact: support@profindle.com' },
