...
export default async function TermsPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  const sections = lang === 'th' ? [
    ...
    { title: 'คำขอบริการ (Broadcast)', body: 'ผู้ที่กำลังมองหาบริการสามารถโพสต์คำขอบริการซึ่งจะถูกส่งไปยังผู้ให้บริการที่ตรงกับบริการ คำขอต้องเป็นความต้องการทางธุรกิจที่แท้จริงและไม่เป็นสแปม เราอาจจำกัดจำนวนคำขอต่อช่วงเวลา Profindle ไม่รับผิดชอบต่อการเจรจา สัญญา หรือการชำระเงินที่เกิดขึ้นระหว่างผู้ใช้' },
