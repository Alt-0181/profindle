...
export default async function TermsPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  const sections = lang === 'th' ? [
    { title: 'การยอมรับข้อกำหนด', body: 'การใช้ Profind แสดงว่าคุณยอมรับข้อกำหนดเหล่านี้ หากคุณไม่เห็นด้วยกับส่วนใด กรุณาอย่าใช้บริการของเรา' },
    { title: 'คำอธิบายบริการ', body: 'Profind เป็นตลาดธุรกิจ B2B ที่เชื่อมต่อบริษัทที่กำลังมองหาบริการกับผู้ให้บริการ เราทำหน้าที่เป็นแพลตฟอร์มเท่านั้น ไม่ใช่คู่สัญญาในการทำธุรกรรมระหว่างผู้ใช้ และไม่รับประกันผลลัพธ์ของการติดต่อหรือการว่าจ้างใดๆ' },
    ...
    { title: 'การใช้งานที่ยอมรับได้', body: 'คุณตกลงที่จะใช้ Profind เพื่อวัตถุประสงค์ทางธุรกิจที่ถูกต้องตามกฎหมายเท่านั้น ห้ามส่งสแปม หลอกลวง ดึงข้อมูล (scraping) โดยอัตโนมัติ หรือกระทำการใดๆ ที่อาจเป็นอันตรายต่อผู้ใช้รายอื่นหรือแพลตฟอร์ม' },
    { title: 'คำขอบริการ (Broadcast)', body: 'ผู้ซื้อสามารถโพสต์คำขอบริการซึ่งจะถูกส่งไปยังผู้ให้บริการที่ตรงกับบริการ คำขอต้องเป็นความต้องการทางธุรกิจที่แท้จริงและไม่เป็นสแปม เราอาจจำกัดจำนวนคำขอต่อช่วงเวลา Profind ไม่รับผิดชอบต่อการเจรจา สัญญา หรือการชำระเงินที่เกิดขึ้นระหว่างผู้ใช้' },
    ...
    { title: 'แพ็กเกจและการชำระเงิน', body: 'Profind มีแพ็กเกจฟรีและแพ็กเกจ Premium ในช่วงเปิดตัว (Early Bird) ผู้ใช้กลุ่มแรกอาจได้รับฟีเจอร์ Premium ฟรีจนถึง 31 มีนาคม 2570 ตามเงื่อนไขที่กำหนด เราอาจปรับเปลี่ยนฟีเจอร์หรือราคาในอนาคต โดยจะแจ้งให้ทราบล่วงหน้าตามสมควร' },
    { title: 'ทรัพย์สินทางปัญญา', body: 'เนื้อหาที่คุณโพสต์บน Profind ยังคงเป็นของคุณ คุณให้สิทธิ์แก่เราในการแสดงและแจกจ่ายภายในบริการของเรา โลโก้ แบรนด์ และซอฟต์แวร์ของ Profind เป็นทรัพย์สินของเรา' },
    ...
    { title: 'ข้อจำกัดความรับผิด', body: 'Profind ให้บริการ “ตามที่เป็น” เราไม่รับประกันว่าแพลตฟอร์มจะไม่มีข้อผิดพลาดหรือมีให้บริการตลอดเวลา และไม่รับผิดต่อความเสียหายทางอ้อมหรือโดยบังเอิญที่เกิดจากการใช้บริการ' },
    ...
    { title: 'Acceptance of Terms', body: 'By using Profind, you agree to these terms. If you disagree with any part, please do not use our service.' },
    { title: 'Description of Service', body: 'Profind is a B2B marketplace that connects companies seeking services with providers. We act as a platform only — not a party to any transaction between users — and we do not guarantee the outcome of any contact or engagement.' },
    ...
    { title: 'Acceptable Use', body: 'You agree to use Profind only for lawful business purposes. Do not spam, deceive, automatically scrape data, or take any action that could harm other users or the platform.' },
    { title: 'Broadcast Requests', body: 'Buyers may post service requests, which are sent to providers whose services match. Requests must be genuine business needs and not spam. We may limit the number of requests per period. Profind is not responsible for negotiations, contracts, or payments made between users.' },
    ...
    { title: 'Plans & Payment', body: 'Profind offers a Free plan and a Premium plan. As a launch (Early Bird) offer, early users may receive Premium features free until 31 March 2027, subject to the stated conditions. We may change features or pricing in the future, with reasonable prior notice.' },
    { title: 'Intellectual Property', body: 'Content you post on Profind remains yours. You grant us a license to display and distribute it within our service. Profind\'s logo, brand, and software are our property.' },
    ...
    { title: 'Limitation of Liability', body: 'Profind provides services "as is." We do not warrant that the platform will be error-free or always available, and we are not liable for indirect or incidental damages arising from use of the service.' },
      ...
      <div style={{ background: 'white', borderBottom: '1px solid #E4E7ED', padding: '16px 0' }}>
        <div style={{ maxWidth: '860px', margin: '0 auto', padding: '0 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <Link href={`/${lang}`} style={{ textDecoration: 'none' }}>
            <img src="/assets/logo.svg" alt="Profind" style={{ height: '26px', width: 'auto' }} />
          </Link>
